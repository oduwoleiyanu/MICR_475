...
```{r figure 1, echo=FALSE, fig.cap="Fig 1(Bad  plot)", out.width = '100%'}
knitr::include_graphics("iyanubadplot.png")
```
**Figure 2(good plot)**
...
```{r figure 2, echo=FALSE, fig.cap="Fig 2 (good plot)", out.width = '100%'}
knitr::include_graphics("goodplot.png")
